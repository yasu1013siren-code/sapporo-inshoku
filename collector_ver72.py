...
LOG_PATH = BASE_DIR / "collector_ver72.log"
REPORT_JSON_PATH = BASE_DIR / "collector_ver72_report.json"
REPORT_CSV_PATH = DATA_DIR / f"collector_ver72_report_{datetime.now():%Y-%m-%d}.csv"
...
SOURCE_CONFIG = [
    ...
    # 深掘り用追加ソース：地域別新店情報
    {"id": "chamonix_chitose", "name": "札幌開店閉店インフォ・千歳市", "url": "https://chamonix-cakes.com/category/%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/%E5%8D%83%E6%AD%B3%E5%B8%82%E3%81%AE%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/", "kind": "article_list", "priority": 70, "force_ward": "千歳市", "default_status": "open"},
    {"id": "chamonix_eniwa", "name": "札幌開店閉店インフォ・恵庭市", "url": "https://chamonix-cakes.com/category/%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/%E6%81%B5%E5%BA%AD%E5%B8%82%E3%81%AE%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/", "kind": "article_list", "priority": 70, "force_ward": "恵庭市", "default_status": "open"},
    {"id": "chamonix_kitahiroshima", "name": "札幌開店閉店インフォ・北広島市", "url": "https://chamonix-cakes.com/category/%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/%E5%8C%97%E5%BA%83%E5%B3%B6%E5%B8%82%E3%81%AE%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/", "kind": "article_list", "priority": 70, "force_ward": "北広島市", "default_status": "open"},
    {"id": "chamonix_tomakomai", "name": "札幌開店閉店インフォ・苫小牧市", "url": "https://chamonix-cakes.com/category/%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/%E8%8B%AB%E5%B0%8F%E7%89%A7%E5%B8%82%E3%81%AE%E6%96%B0%E5%BA%97%E6%83%85%E5%A0%B1/", "kind": "article_list", "priority": 70, "force_ward": "苫小牧市", "default_status": "open"},
...
def article_candidates(source: dict, max_items: int = 120):
    ...
    # 一覧ページのページネーションも最大5ページまで追跡して深掘りする。
    html_pages = [html]
    visited_pages = {source["url"]}
    current_soup = BeautifulSoup(html, "lxml")
    for _page_no in range(2, 6):
        next_url = ""
        for a_next in current_soup.find_all("a", href=True):
            label = clean(a_next.get_text(" ", strip=True))
        ...
        if not next_url or not is_allowed_by_robots(next_url):
            break
        next_html = fetch_text(next_url)
        if not next_html:
            break
        html_pages.append(next_html)
        visited_pages.add(next_url)
        current_soup = BeautifulSoup(next_html, "lxml")
